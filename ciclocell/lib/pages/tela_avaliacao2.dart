...
class TelaAvaliacao2 extends StatefulWidget {
   ...
   static const routeName = "avaliacao2";
...
class _TelaAvaliacao2State extends State<TelaAvaliacao2> {
  ...
  Widget build(BuildContext context) {
    ...
    final argumentosAv = ModalRoute.of(context)!.settings.arguments as ArgumentosAvaliacao;
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {                    
                        AvaliacaoController().criarAvaliacao(context,argumentosAv.marca, argumentosAv.modelo, argumentosAv.memoriaRam,
                          argumentosAv.memoriaInterna, telaTroc, telaTrinc, traseira, detalhes, bateria);                                
                        Navigator.pushReplacementNamed(context, "avaliacao3");
